...
import routes_auth, routes_structure, routes_users, routes_timetable, routes_attendance, routes_dashboard
...
for module in (routes_auth, routes_structure, routes_users, routes_timetable, routes_attendance, routes_dashboard):
